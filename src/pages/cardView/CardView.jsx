    ...
    <div className=''>     
     <div className="container-fluid bg-light  mb-4 mt-3">
        <div className="row ">
          ...
          <div className="col-lg-4 container border rounded  border bg-light mt-4">
            ...
            <h6 className='box' style={{ fontSize: 'clamp(16px, 1.2vw, 20px)' }}>Stay Included This Package</h6>


            <div>
              
              <label htmlFor="dorm" style={{ fontSize: 'clamp(12px, 1.2vw, 20px)' }}>Dorm</label>
            </div>

            <div className="d-flex align-items-center flex-wrap mt-2">
              <h6 className='m-0 mt-2' style={{ fontSize: 'clamp(12px, 1.2vw, 20px)' }}>Cities Included:</h6>
              {cities.map(city => (
            ...
            <div className="package-icons d-flex mt-3" >
              ...
              <div className="d-flex mx-2 align-items-center mb-3 flex-column">
                <MdOutlineFoodBank style={{ fontSize: 'clamp(12px, 1.2vw, 27px)' }} alt="Meals Logo" className="logo mb-1" />
                <h6 className="mb-0 box" style={{ fontSize: 'clamp(12px, 3vw, 15px)' }}>Meals</h6>
              </div>
              <div className="d-flex mx-2 align-items-center mb-3 flex-column">
                <GrOverview style={{ fontSize: 'clamp(12px, 1.2vw, 27px)' }} alt="sightseeing Logo" className="logo mb-1" />
                <h6 className="mb-0 box" style={{ fontSize: 'clamp(12px, 3vw, 15px)' }}>Sightseeing</h6>
              </div>
              <div className="d-flex mx-3 align-items-center mb-3 flex-column">
                <RiGuideFill style={{ fontSize: 'clamp(12px, 1.2vw, 27px)' }} alt="sightseeing Logo" className="logo mb-1" />
                <h6 className="mb-0 box" style={{ fontSize: 'clamp(12px, 3vw, 15px)' }}>Travel Guide</h6>
              </div>
              <div className="d-flex mx-2 align-items-center mb-3 flex-column">
                <FaCarSide style={{ fontSize: 'clamp(12px, 1.2vw, 27px)' }} alt="sightseeing Logo" className="logo mb-1" />
                <h6 className="mb-0 box" style={{ fontSize: 'clamp(12px, 3vw, 15px)' }}>Transfers</h6>
              </div>
            </div>
            <hr className="mt-2" />
            <div className="mt-2">
              ...
              <div className='display-inline d-flex justify-content-between align-items-center'>
                ...
                <div className="text-end">
                  ...
                  <p className="m-0 box" style={{ fontSize: 'clamp(12px, 1.2vw, 15px)' }}><FaRegCalendarAlt />10-03-2024</p>
                </div>
              </div>
            </div>
            <hr />
