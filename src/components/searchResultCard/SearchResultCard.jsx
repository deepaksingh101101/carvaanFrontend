...
export default function SearchResultCard() {
  return (
    <div className="container search_result_card_section  my-5" style={{maxWidth: "935.216px"}}>
        ...
        <div className="col-md-12 px-0 px-lg-2 col-lg-3" >
            <div className="d-flex flex-column  px-3 py-3 px-sm-0 py-sm-0  ">
                <img className='object-fit-cover my-0 my-lg-2  search_result_image'  src={search1}  alt='searchResult1'/>
        ...
        <div className="col-lg-9 ps-lg-1  px-md-2 px-lg-3  pt-lg-2 " >
            ...
            <h4 className='search_result_title mb-0'>Trip to Kanyakumari (New Year Special)</h4>
            <span>
            <FaRegHeart className='heart heart_ me-2' style={{fontSize:"25px"}} />
            </span>
            </div>
...
{/* Duration */}
        <div className="d-flex align-items-center justify-content-between justify-content-lg-start">
            <p className='fw-semibold my-0 search_result_duration' >4 days 3 Night</p>
       ...
       <div className="d-flex align-items-center mt-0 mt-sm-0 mt-md-3 mt-lg-3">
            ...
            < button className=' mx-2 search_result_price_btn '>24% Off</button>
        </div>


        <div className="d-flex align-items-center mt-1 mt-sm-1 mt-md-3 mt-lg-3 ">
            <div className="d-flex flex-column justify-content-center ">
            <h4 className='my-0 search_result_oprice fw-bold ' >$ 13,345/-</h4>
            <p className='per_person mb-0 fw-semibold' >Per Person</p>
            </div>
            <p className='my-1 mx-2 '  ><s className='date-grey dprice' >$ 13,345</s></p>
        </div>
       </div>
  ...
  <label className="form-check-label fw-semibold" htmlFor="flexRadioDefault1">
   Camp
  </label>
            </div>
            <div className="mx-2 form-check">
  <input className="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault2" checked/>
  <label className="fw-semibold form-check-label" htmlFor="flexRadioDefault2">
    Hotel
  </label>
            </div>
            <div className="mx-2 form-check">
